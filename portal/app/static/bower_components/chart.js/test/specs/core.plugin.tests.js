describe('Chart.plugins', function() {
	...
	describe('configback.options.plugins', function() {
		...
		it('should not called plugins when configback.options.plugins.{id} is FALSE', function() {
			var plugins = {
				a: {id: 'a', hook: function() {}},
				b: {id: 'b', hook: function() {}},
				c: {id: 'c', hook: function() {}}
		...
		it('should call plugins with default options if plugin configback options is undefined', function() {
			var plugin = {id: 'a', hook: function() {}};
