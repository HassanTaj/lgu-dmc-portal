...
describe('Time scale tests', function() {
	...
	it('should have the correct default configback', function() {
	...
	it('should build ticks using the configback unit', function() {
		var mockData = {
	...
	it('should build ticks using the configback diff', function() {
		var mockData = {
	...
	describe('configback step size', function() {
