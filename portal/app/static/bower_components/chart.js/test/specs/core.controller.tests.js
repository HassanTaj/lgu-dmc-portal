describe('Chart', function() {
	...
	describe('configback initialization', function() {
		it('should create missing configback.data properties', function() {
			var chart = acquireChart({});
			var data = chart.data;
		...
		it('should not alter configback.data references', function() {
		...
		it('should define chart.data as an alias for configback.data', function() {
		...
		it('should initialize configback with default options', function() {
	...
	describe('when merging scale options', function() {
		...
		it('should not alter defaults when merging configback', function() {
			var chart = acquireChart({
				type: 'line',
				options: {
					_jasmineCheck: 42,
	...
	describe('configback.options.responsive: false', function() {
	...
	describe('configback.options.responsive: true (maintainAspectRatio: false)', function() {
	...
	describe('configback.options.responsive: true (maintainAspectRatio: true)', function() {
	...
	describe('configback.options.devicePixelRatio', function() {
		beforeEach(function() {
			this.devicePixelRatio = window.devicePixelRatio;
	...
	describe('configback update', function() {
